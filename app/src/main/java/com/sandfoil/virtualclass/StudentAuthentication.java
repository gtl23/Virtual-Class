...
public class StudentAuthentication extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = "StudentAuthentication";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(!isConnected(StudentAuthentication.this)) buildDialog(StudentAuthentication.this).show();


        mPhoneNumberField =  findViewById(R.id.student_phone_number_edittext);
        mVerificationField =  findViewById(R.id.student_phone_otp_edittext);
        mStartButton = findViewById(R.id.student_verification_sendotp_button);
        mVerifyButton = findViewById(R.id.student_verification_verify_button);
        mResendButton = findViewById(R.id.student_verification_resendotp_button);
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        final ProgressDialog progressDialog = new ProgressDialog(StudentAuthentication.this);
...
//                            FirebaseUser user = task.getResult().getUser();
                            ...
                            startActivity(new Intent(StudentAuthentication.this, CreateStudentProfile.class));
                            finish();
                        } else {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.student_verification_sendotp_button:
...
//                            return;
                            ...
                            Toast.makeText(StudentAuthentication.this, "Already Registered.", Toast.LENGTH_SHORT).show();
//                            return;
                        } else {
                ...
                break;
            case R.id.student_verification_verify_button:
                ...
                break;
            case R.id.student_verification_resendotp_button:
